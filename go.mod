...
require (
	...
	github.com/chainguard-dev/kaniko v1.25.6 // indirect
...
replace (
	...
	// Pack: release/build uses this pinned version only. After fixing pack, push octopilot/pack then run: GOPROXY=direct go get github.com/octopilot/pack@<commit-sha> && go mod vendor (see CONTRIBUTING.md).
	github.com/buildpacks/pack => github.com/octopilot/pack v0.0.0-20260301171535-59c81a3c9764
